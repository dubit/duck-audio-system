...
namespace Duck.AudioSystem
{
	...
	public class AudioConfig : AbstractAudioConfig
	{
		...
		public SpatialModes SpatialMode => spatialMode;
		...
		/// </summary>
		internal UnityObjectDictionary<AudioSource, Action> Callbacks => callbacks;
		...
		/// </summary>
		public AudioSource CurrentChannel => occupiedChannels.LastOrDefault();
